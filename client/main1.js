...
(function (window) {
    ...
    define(['angularAMD'], function (angularAMD) {//'navMenu'
        ...
        app.directive('pageView',['$compile', 'appViewModel', function($compile, appViewModel){
            return {
                restrict: 'AE',
                replace: 'true',
                transclude:true,
                //template:'<div data-ng-include data-ng-src="getPartial()"></div>',
                /*compile: function(element, attrs) {
                    return function(scope, element, attrs) {
                        ...
                        scope.$on('changeMasterView', function(e, args){ setActiveView(args.name) });
                    };
                },*/
